...
class StockproductView extends GetView {
  final Product product;

  const StockproductView({Key? key, required this.product}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Get.toNamed('/productdetailkaryawan', arguments: product);
      },
      child: Card(
        elevation: 2,
