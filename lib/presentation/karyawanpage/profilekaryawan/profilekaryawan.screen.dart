...
import 'controllers/profilekaryawan.controller.dart';

class ProfilekaryawanScreen extends GetView<ProfilekaryawanController> {
  const ProfilekaryawanScreen({Key? key}) : super(key: key);
  @override
